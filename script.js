function imprimeArray() {
    ...
    var result = 
      ...
      "Com " + kmRodados + " KM rodados." + "<br>"+
      "Em " + horasTrabalhadas + " horas trabalhadas." + "<br>"+
      "Total de ganhos do dia: " + ganhos + " Reais." + "<br>"+
      "Ganhos por KM: " + ganhosPorKM + " Reais por KM rodado." + "<br>"+
      "Ganhos por hora: " + ganhosPorHora + " Reais por hora.";
